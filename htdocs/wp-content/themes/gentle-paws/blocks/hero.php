<?php
	...
	$times = get_sub_field('opening_times');
?>

<section class="relative w-full h-screen bg-center bg-no-repeat bg-cover" style="background-image:url('<?php echo $bg_img; ?>');">
	...
	<div class="w-full h-screen lg:w-11/12 bg-gradient-to-r from-pink"></div>
	<?php if ( $times ) : ?>
