...
<?php get_header(); ?>
	...
	<section class="relative w-full pt-40 pb-24 text-white bg-navy">
			<div class="container flex flex-col lg:flex-row lg:justify-between">
				...
				<div>
					<h1 class="max-w-2xl pr-12 mb-12 font-bold leading-tight text-36 sm:text-46 md:text-60 lg:text-70 lg:pr-0">Blog</h1>
					<span class="inline-block max-w-xl leading-tight text-26 md:text-28 lg:text-32"><?php the_field('intro_text', 26); ?></span>
				</div>
			</div>
		</section>

		<section class="w-full pt-20 pb-10 bg-white text-navy md:pt-24 md:pb-16 lg:pt-28 lg:pb-20">

		<div class="container">
    	<div class="w-full">
      	<h2 class="font-bold text-26 md:text-32 lg:text-40 xl:text-46 mb-7 sm:mb-0">Latest Posts</h2>
    	</div>
		</div>
			...
			<div class="container">
				...
				$query = new WP_Query( array(
					...
					while ( $query->have_posts() ) : $query->the_post();?>
						...
						<div class="w-full md:mb-6 lg:mb-8">
							<div>
		...
		<section class="w-full py-20 text-white bg-blue md:py-24 lg:py-28">
			<div class="container">
				<div class="w-full">
					<h2 class="font-bold text-26 md:text-32 lg:text-40 xl:text-46 mb-7"><?php the_field('title'); ?></h2>
